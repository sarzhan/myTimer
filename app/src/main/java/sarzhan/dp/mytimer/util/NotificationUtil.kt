...
import sarzhan.dp.mytimer.AppConstants
import sarzhan.dp.mytimer.R
import sarzhan.dp.mytimer.TimerActivity
import sarzhan.dp.mytimer.TimerNotificationActionReceiver
...
class NotificationUtil {
    companion object{
        ...
        private fun getBasicNotificationBuilder(context: Context, chanelId:String,playSound:Boolean):NotificationCompat.Builder{
...
@TargetApi(26)
        private fun NotificationManager.createNotificationChannel(chanelId:String,channelName: String,playSound: Boolean){
            if (Build.VERSION.SDK_INT>= Build.VERSION_CODES.O){
                val channelImportance = if (playSound) NotificationManager.IMPORTANCE_DEFAULT
                else NotificationManager.IMPORTANCE_LOW
                val nChannel= NotificationChannel(chanelId, channelName,channelImportance)
